...
function google (query, options, callback) {
  var startIndex = 0
  ...
  igoogle(query, startIndex, options, callback)
}
...
var igoogle = function (query, start, options, callback) {
  ...
  request(requestOptions, function (err, resp, body) {
    if ((err == null) && resp.statusCode === 200) {
      ...
      if ($(nextSel).last().text() === google.nextText) {
        res.next = function () {
          igoogle(query, start + google.resultsPerPage, options, callback)
        }
      }
